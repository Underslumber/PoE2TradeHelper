...
Сервис должен работать в той же локальной сети и иметь право отправлять UDP broadcast. Доступ к кнопке есть только у администратора приложения; учётные данные роутера не используются.
