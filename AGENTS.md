...
- Для `ItemBases` не блокируй UI длинным `Retry-After`: если trade2 просит ждать сотни секунд, возвращай понятную ошибку/частичный результат и продолжай показывать уже собранный список основ. Фильтр по имени должен фильтровать сохраненный/кэшированный рынок, а не затирать общий снимок частичной выборкой. Даже fallback-каталог основ должен иметь русские видимые названия, русские группы и иконки; английские `Fallback`/base names не выводи в русской версии UI.
