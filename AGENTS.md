...
- Для оценки предметов продавца сравнивай не только название: учитывай тип базы, редкость, item level и нормализованные явные аффиксы. Если полностью аналогичных лотов мало, ослабляй сравнение до "аффиксы минус один"; только после этого используй запасной ориентир по типу и уровню.
