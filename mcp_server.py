...
# Конфигурация
UA = os.environ.get("USER_AGENT", "poe2-mcp/0.1 (+contact)")
COOL = int(os.environ.get("RATE_COOLDOWN_MS", "200"))
...
async def get_currency_exchange(
    ...
    try:
        ...
        return {"error": str(e), "status_code": getattr(e, 'status_code', None) or 500}
